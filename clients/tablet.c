...
static void
tablet_down_handler(struct widget *widget, struct tablet_tool *tool, uint32_t time,
		    void *data)
{
	tablet_is_down = true;
}
...
static void
tablet_up_handler(struct widget *widget, struct tablet_tool *tool, uint32_t time,
		  void *data)
{
